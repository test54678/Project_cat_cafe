    ...
    @endif
      ...
      <form action="{{route('contact')}}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input id="name" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）田中太郎" name="name" value="{{old('name', "田中太郎")}}">
          @if($errors->has('name'))
