    ...
    <div class="mt-8">
      ...
      <form action="{{route('contact')}}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input id="name" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）田中太郎" name="name" value="田中太郎">
        </div>
        <div class="mb-4">
          ...
          <input id="name_kana" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）タナカタロウ" name="name_kana" value="タナカタロウ">
        </div>
        <div class="mb-4">
          ...
          <input id="phone" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="例）0312345678" name="phone" value="0312345678">
        </div>
        <div class="mb-4">
          ...
          <input id="email" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="email" placeholder="info@example.com" name="email" value="info@example.com">
        ...
        <div class="mb-4">
          ...
          <textarea id="body" class="w-full h-24 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="ご自由にご記入ください" name="body">abcあいうえお</textarea>
        </div>
